...
class Email(models.Model):
    ...
    _HELP_TEXT = {
        ...
        'source_html_uri': 'Source URI of the email HTML. <a href="#" class="view-email-trigger">View Email Template</a>',
        'source_text_uri': 'Source URI of the email text. <a href="#" class="view-email-trigger">View Email Template</a>',
