...
class Email(models.Model):
    ...
    _HELP_TEXT = {
        ...
        'source_html_uri': 'Source URI of the email HTML. <a href="#" class="modal-trigger" data-id="id_source_html_uri" data-toggle="modal" data-target="#viewUploadModal">Select an uploaded email</a> or <a href="#" data-id="id_source_html_uri" class="view-email-trigger">Preview email</a>',
        'source_text_uri': 'Source URI of the email text. <a href="#" class="modal-trigger" data-id="id_source_text_uri" data-toggle="modal" data-target="#viewUploadModal">Select an uploaded email</a> or <a href="#" data-id="id_source_text_uri" class="view-email-trigger">Preview email</a>',
