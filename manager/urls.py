...
urlpatterns = [
    ...
    url(r'^recipientgroup/create/auto/$',             login_required(create_recipient_group_action),             name='manager-recipientgroup-create-action'),
    ...
    url(r'^segments/$',                               login_required(SegmentListView.as_view()),                 name='manager-segments'),
    url(r'^segments/create/$',                        login_required(SegmentCreateView.as_view()),               name='manager-segments-create'),
    url(r'^segments/(?P<pk>\d+)/update/$',            login_required(SegmentUpdateView.as_view()),               name='manager-segments-update'),
    url(r'^segments/(?P<pk>\d+)/delete/$',            login_required(SegmentDeleteView.as_view()),               name='manager-segments-delete'),
