...
o.trigger("activate.bs.scrollspy")},e.prototype.clear=function(){t(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on("load.bs.scrollspy.data-api",function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.tab");n||o.data("bs.tab",n=new i(this)),"string"==typeof e&&n[e]()})}var i=function(e){this.element=t(e)};i.VERSION="3.3.5",i.TRANSITION_DURATION=150,i.prototype.show=function(){var e=this.element,i=e.closest("ul:not(.dropdown-menu)"),o=e.data("target");if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){var n=i.find(".active:last a"),s=t.Event("hide.bs.tab",{relatedTarget:e[0]}),a=t.Event("show.bs.tab",{relatedTarget:n[0]});if(n.trigger(s),e.trigger(a),!a.isDefaultPrevented()&&!s.isDefaultPrevented()){var r=t(o);this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){n.trigger({type:"hidden.bs.tab",relatedTarget:e[0]}),e.trigger({type:"shown.bs.tab",relatedTarget:n[0]})})}}},i.prototype.activate=function(e,o,n){function s(){a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),e.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),r?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu").length&&e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),n&&n()}var a=o.find("> .active"),r=n&&t.support.transition&&(a.length&&a.hasClass("fade")||!!o.find("> .fade").length);a.length&&r?a.one("bsTransitionEnd",s).emulateTransitionEnd(i.TRANSITION_DURATION):s(),a.removeClass("in")};var o=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=i,t.fn.tab.noConflict=function(){return t.fn.tab=o,this};var n=function(i){i.preventDefault(),e.call(t(this),"show")};t(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',n).on("click.bs.tab.data-api",'[data-toggle="pill"]',n)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.affix"),s="object"==typeof e&&e;n||o.data("bs.affix",n=new i(this,s)),"string"==typeof e&&n[e]()})}var i=function(e,o){this.options=t.extend({},i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};i.VERSION="3.3.5",i.RESET="affix affix-top affix-bottom",i.DEFAULTS={offset:0,target:window},i.prototype.getState=function(t,e,i,o){var n=this.$target.scrollTop(),s=this.$element.offset(),a=this.$target.height();if(null!=i&&"top"==this.affixed)return i>n?"top":!1;if("bottom"==this.affixed)return null!=i?n+this.unpin<=s.top?!1:"bottom":t-o>=n+a?!1:"bottom";var r=null==this.affixed,l=r?n:s.top,h=r?a:e;return null!=i&&i>=n?"top":null!=o&&l+h>=t-o?"bottom":!1},i.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(i.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},i.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},i.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=this.$element.height(),o=this.options.offset,n=o.top,s=o.bottom,a=Math.max(t(document).height(),t(document.body).height());"object"!=typeof o&&(s=n=o),"function"==typeof n&&(n=o.top(this.$element)),"function"==typeof s&&(s=o.bottom(this.$element));var r=this.getState(a,e,n,s);if(this.affixed!=r){null!=this.unpin&&this.$element.css("top","");var l="affix"+(r?"-"+r:""),h=t.Event(l+".bs.affix");if(this.$element.trigger(h),h.isDefaultPrevented())return;this.affixed=r,this.unpin="bottom"==r?this.getPinnedOffset():null,this.$element.removeClass(i.RESET).addClass(l).trigger(l.replace("affix","affixed")+".bs.affix")}"bottom"==r&&this.$element.offset({top:a-e-s})}};var o=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=i,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var i=t(this),o=i.data();o.offset=o.offset||{},null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)})})}(jQuery),function(){"use strict";function t(){c?(clearInterval(s),a.parents(".alert").removeClass("alert-info").addClass("alert-danger"),a.parent().replaceWith("<strong>Error: The email send may have failed, the start time is more than 24 hours ago.</strong>"),l.slideUp()):$.ajax({url:d,data:{pk:n}}).done(function(t){if(t.end)window.location.reload();else if(t.error)a.parents(".alert").text(t.error);else if(new Date-new Date(t.start)>p)c=!0;else{var e=Math.round(t.sent_count/t.total*100);"number"==typeof e?e+="%":e="0%",a.css("width",e).text(e),r.text(t.sent_count+" of "+t.total)}}).fail(function(){clearInterval(s),a.parents(".alert").text("Error retrieving sent email data.")})}function e(){h.hasClass("open-instance-page")?window.location=INSTANCE_URL+n+"#check_on_load":(n=h.siblings("input.email-instance-id").val(),i("/email/instance/"+n+"/cancel/",h))}function i(t){$.ajax({url:t,data:{pk:n}}).success(function(t){h.children(".text").text("Cancelling Instance..."),h.children(".spinner-loader").removeClass("hidden")}).error(function(t,e,i){h.children(".text").text("Cancel This Instance"),h.children(".spinner-loader").addClass("hidden")})}function o(){var i=window.location.hash.replace("#","");l=$(".cancel-instance-form"),a=$(".progress-bar"),h=$(".cancel-instance-btn"),"check_on_load"===i&&h.length>0&&e(),n=$("input.email-instance-id").val(),a.length&&(r=$(".sent"),s=setInterval(t,2e3)),l.on("click",".cancel-instance-btn",function(t){t.preventDefault(),e()})}var n,s,a,r,l,h,d="/instance/json/?pk=",c=!1,p=864e5;$(o)}(),function(){"use strict";function t(){h.find(".attribute").each(function(t){var e=$(this).find("input");e.eq(0).attr("id","id_attributes-"+t+"-id").attr("name","attributes-"+t+"-id"),e.eq(1).attr("id","id_attributes-"+t+"-name").attr("name","attributes-"+t+"-name"),e.eq(2).attr("id","id_attributes-"+t+"-value").attr("name","attributes-"+t+"-value")})}function e(){c.val(h.find(".attribute").length)}function i(t){return t.replace(/\d+/g,function(t){return++t})}function o(o){o.preventDefault();var n=r.clone().removeClass("hide");n.appendTo(h),l?t():n.find("input").each(function(){$(this).attr("id",i($(this).attr("id"))),$(this).attr("name",i($(this).attr("name")))}),e()}function n(i){i.preventDefault(),l?($(i.target).closest(".attribute").remove(),t()):($(i.target).closest(".attribute").hide(),$(i.target).next().prop("checked",!0)),e()}function s(t){$(t.target).closest(".form-group").toggleClass("alert-"+$(t.target).attr("data-color"))}function a(){l=-1!==window.location.pathname.toString().indexOf("recipient/create/"),r=h.find(".attribute").last().clone().appendTo("body").addClass("hide"),$("form:first *:input[type=text]:first").focus(),$(".add-attr-btn").on("click",o),h.on("click","span",n),h.on("mouseover","span",s),d.on("mouseover","span",s),h.on("mouseout","span",s),d.on("mouseout","span",s)}var r,l=!1,h=$(".attribute-container"),d=$(".add-attr-container"),c=$("#id_attributes-TOTAL_FORMS");$(a)}(),function(){$("#tb_recipient_search").focus();var t=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("email_address"),queryTokenizer:Bloodhound.tokenizers.whitespace,remote:"/recipients/json/?search=%QUERY"});t.clearPrefetchCache(),t.initialize(),$("#tb_recipient_search").typeahead({hint:!1,minLength:3,limit:10,highlight:!0},{displayKey:"email_address",source:t.ttAdapter()}),$("#tb_recipient_search").bind("typeahead:selected",function(t,e,i){$("#tb_recipient_search").val(e.email_address)})}(),function(){"use strict";function t(t){var e=$(t.target).parent().attr("data-link-url");e&&(window.location=e)}function e(){$("table").on("click","td:not(:has(a))",t),$('[data-toggle="tooltip"]').tooltip()}$(e)}();